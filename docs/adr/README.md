...
decision, numbered, append-only (supersede rather than rewrite). Format:
Status / Context / Decision / Consequences.

- [0001](0001-selection-invariant-single-home.md) — Selection invariant has one home
...
- [0006](0006-office-free-dialog-url.md) — Office-free dialog-URL resolution
